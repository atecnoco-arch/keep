...
class SnmpProvider(BaseProvider):
    ...
    def start_consume(self):
        ...
        if self.authentication_config.v3_user:
            auth_proto = usmHMACSHAAuthProtocol if self.authentication_config.v3_auth_proto.lower() == "sha" else usmHMACMD5AuthProtocol
            priv_proto = usmAesCfb128Protocol if self.authentication_config.v3_priv_proto.lower() == "aes" else usmDesPrivProtocol
